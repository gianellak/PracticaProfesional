...
// Muestra los tres campos iniciales para crear una venta.
	...
	public void mostrarCliente(Persona cliente) {
		...
		JLabel compradorLabel = new JLabel("Sr./Sra.: " + cliente.getApellido()+ " " + cliente.getNombre());
...
//		});
	...
	public void mostrarGarante(Persona cliente) {
		...
		JLabel garanteLabel = new JLabel("Sr./Sra.: " + cliente.getApellido()+ " " + cliente.getNombre());
...
//		});
	...
	public void mostrarPatente(Vehiculo vehiculo) {
		...
		JLabel vehiculoLabel = new JLabel("Vehículo: " + vehiculo.getMarca()+ " " + vehiculo.getModelo());
...
//		
	...
	public void mostrarDetalleVenta(int idVenta, String cliente, String garante,String vehiculo){
	...
	public void ingresarDetalleVenta(int idVenta, String cliente, String garante,String vehiculo, int precio) {
			  ...
			  public void changedUpdate(DocumentEvent e) {
				  ...
				  public void warn() {
				     if (Integer.parseInt(adelantoText.getText())>0){
				    	 Double d = (double) (precio + Integer.valueOf(comisionText.getText()) - Integer.valueOf(adelantoText.getText()));
		...
		btnAceptarNuevaV = new JButton("Aceptar");
		btnAceptarNuevaV.setPreferredSize(preferredSize);
		btnAceptarNuevaV.setBounds(650, 300, 150, 25);
		this.add(btnAceptarNuevaV);
	...
	public void calendar(){
		...
		JLabel calendario = new JLabel("Seleccione vencimiento de la primera cuota: ");
